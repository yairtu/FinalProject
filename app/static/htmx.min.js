(function (e, t) {
    ...
    return function () {
        ...
        function rr(s, l) {
                ...
                var o = function () {
                    try {
                        ...
                        if (t.elt && !Y(t.elt) && t.elt.id) {
                            ...
                            var i = {preventScroll: v.focusScroll !== undefined ? !v.focusScroll : !U.config.defaultFocusScroll};
                            if (r) {
            ...
            if (e) {
                J(s, "htmx:responseError", Q({error: "Response Status Error Code " + u.status + " from " + l.pathInfo.path}, l))
            }
        }
